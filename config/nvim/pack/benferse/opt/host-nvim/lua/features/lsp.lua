...
local function on_attach(client, buffer)
    ...
    map('n', '<leader>ll', '<cmd>lua vim.diagnostic.setloclist()<cr>', { buffer = buffer, name = "Loclist diagnostics"})
    map('n', '<leader>ln', '<cmd>lua vim.lsp.buf.rename()<cr>', { buffer = buffer, name = "Refactor: Rename" })
    map('n', '<leader>lq', '<cmd>lua vim.diagnostic.setqflist()<cr>', { buffer = buffer, name = "Quickfix diagnostics" })
